...
namespace SharedUI
{
    ...
    public class ModalDismissableAlert : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("cancelButton")] public ButtonManager okButton;
        ...
        public Sprite alertImageSprite;
        [TextArea(1, 4)] public string descriptionText = "Description here";

        // Events
        public UnityEvent onOpen = new();
        public UnityEvent onClose = new();
        [FormerlySerializedAs("onConfirm")] public UnityEvent onOK = new();
        ...
        void Awake()
        {
            ...
            if (closeOnCancel) onOK.AddListener(CloseWindow);
            if (closeOnConfirm) onOK.AddListener(CloseWindow);
            if (okButton != null) okButton.onClick.AddListener(onOK.Invoke);
        ...
        public void UpdateUI()
        {
            ...
            if (alertImage != null) alertImage.sprite = alertImageSprite;
            if (windowTitle != null) windowTitle.text = titleText;
            if (windowDescription != null) windowDescription.text = descriptionText;

            if (showCancelButton && okButton != null)
                okButton.gameObject.SetActive(true);
            else if (okButton != null) okButton.gameObject.SetActive(false);
        }
